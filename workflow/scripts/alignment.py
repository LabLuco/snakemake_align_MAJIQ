...
def align(scriptdir,genomedir,namelist):
    for name in namelist :
        ...
        starcommand = 'STAR --runThreadN 3 --genomeDir '+genomedir+' --outFileNamePrefix '+outfileprefix+' --readFilesIn '+fwd+' '+rev+' --readFilesCommand zcat'
...
if __name__ == "__main__":
    ...
    genomedir = scriptdir+'/../../resources/droso_melanogaster_genome/'
