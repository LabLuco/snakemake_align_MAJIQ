...
def deltapsi(scriptdir,majiqlist):
    ...
    dpsicommand = 'majiq deltapsi -grp1 '+controllist+' -grp2 '+testlist+' -j 10 --min-experiments '+str(snakemake.params[2])+' -o '+outputdir+' -n '+snakemake.params[0]+' '+snakemake.params[1]
